...
public class ResultPage_Testcases extends Annotations {
	Boolean bEditMode;

	@BeforeTest
	public void setData() {
		excelFileName = "ResultPage";

	}

	@Test(dataProvider = "fetchData")
	public void ResultPage(String Url, String userName, String password, String ReportNames,String ExpectedStrs)
