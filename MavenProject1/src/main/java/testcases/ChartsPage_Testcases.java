...
public class ChartsPage_Testcases extends Annotations {
	Boolean bEditMode;

	@BeforeTest
	public void setData() {
		excelFileName = "ChartsPage";

	}

	@Test(dataProvider = "fetchData")
	public void ChartsPage(String Url, String userName, String password, String ReportNames, String ExpectedStrs, String fileWithPath)
