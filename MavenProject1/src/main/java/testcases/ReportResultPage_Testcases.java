...
public class ReportResultPage_Testcases extends Annotations {
	Boolean bEditMode;

	@BeforeTest
	public void setData() {
		excelFileName = "ReportResultPage";

	}

	@Test(dataProvider = "fetchData")
	public void ReportResultPage(String Url, String userName, String password, String ReportNames, String ExpectedStrs,
